...
const fonts = `Livvic, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Helvetica, sans-serif`
...
const theme = {
  ...
  shadows: {
    ...
    card: '0 2px 2px rgba(0, 0, 0, 0.25)',
    elevated:
